...
export default function Sidebar({
  ...
  const navItems = [
    ...
    { id: "calendar", label: "Calendar", icon: "calendar", onClick: onOpenCalendar },
  ];

  return (
    <div className="h-full min-h-screen md:min-h-[calc(100vh-64px)] p-5 md:p-6 flex flex-col justify-between bg-gradient-to-b from-slate-50 via-indigo-50/40 to-white dark:from-slate-900 dark:via-slate-900 dark:to-slate-950 transition-colors">
      {/* SVG Symbols */}
      <svg className="hidden">
        <symbol id="trophy" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        ...
        <symbol id="tasks" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 14.25v2.25m3-4.5v4.5m3-6.75v6.75m3-9v9M6 20.25h12A2.25 2.25 0 0 0 20.25 18V6A2.25 2.25 0 0 0 18 3.75H6A2.25 2.25 0 0 0 3.75 6v12A2.25 2.25 0 0 0 6 20.25Z" />
        </symbol>
        <symbol id="calendar" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
            ...
            return (
              <li key={item.id}>
                <button
                  ...
                  type="button"
                  className={`group relative flex w-full items-center gap-3 py-3 px-4 rounded-2xl transition-all duration-200 hover:cursor-pointer
                    ${
                      isActive
